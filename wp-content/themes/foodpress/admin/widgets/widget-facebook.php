...
add_action( 'widgets_init', 'fp_facebook_load_widgets' );

function fp_facebook_load_widgets() {
	register_widget( 'fp_facebook_widget' );
}

class fp_facebook_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function fp_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'fp_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'fp_facebook_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'fp_facebook_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'fp_facebook_widget', __('FoodPress: Facebook Like Box', 'fp_facebook_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => 'Find us on Facebook', 'width' => 300, 'height' => 290, 'header' => 'on', 'faces' => 'on');
